...
import Vas from "../../assets/img/komunitas/content-vas.png";
                            ...
                            <div className="w-full my-3">
                                <div className="flex items-start border border-netrals  lg:px-1 px-4 py-8 rounded-lg shadow-[0_2px_10px_2px_rgba(0,0,0,1)] shadow-netrals">
                                    ...
                                    <div className="w-11/12">
                                        ...
                                        <p className="lg:text-xl text-slate-400  ml-2">Bagaimana caranya kita daur ulang limbah sampah kaca menjadi suatu barang yang
                                            bermanfaat ???</p>
                            ...
                            <div className="w-full my-3">
                                <div className="flex items-start border border-netrals px-4  lg:px-1 py-8 rounded-lg shadow-[0_2px_10px_2px_rgba(0,0,0,1)] shadow-netrals">
                                    ...
                                    <div className="w-11/12">
                                        ...
                                        <p className="lg:text-xl text-slate-400  ml-2">Ini adalah cara saya dalam mengolah limbah kaca menjadi vas bunga yang cantik. </p>
                                        <img src={Vas} alt="Vas Bunga" className="mt-2 ml-2" />
                                        <div className="flex justify-between gap-2 mt-4 ml-2">
                                            <div className="flex gap-5 text-slate-400">
                                                <div className="flex gap-1">
                                                    <i><MessageSquare size={15} /></i>
                            ...
                            <div className="w-full my-3">
                                <div className="flex items-start border border-netrals px-4 lg:px-1 py-8 rounded-lg shadow-[0_2px_10px_2px_rgba(0,0,0,1)] shadow-netrals">
                                    ...
                                    <div className="w-11/12">
                                        ...
                                        <p className="text-xl text-slate-400  ml-2">Infonya dong teman-teman cara pengolahan limbah kaca, seperti apa aja contohnya???</p>
                                        <div className="flex justify-between gap-2 mt-4 ml-2">
                                            <div className="flex gap-5 text-slate-400">
                                                <div className="flex gap-1">
                                                    <i><MessageSquare size={15} /></i>
...
export default KomunitasKacaPage